...
import themusicplayer.audioplayer.mp3player.retromusic.activities.ShareInstagramStory
    ...
    override fun onCreateDialog(savedInstanceState: Bundle?): Dialog {
        ...
        return MaterialDialog(requireContext(), BottomSheet(LayoutMode.WRAP_CONTENT))
            ...
            .show {
                ...
                listItems(
                    items = listOf(
                        getString(themusicplayer.audioplayer.mp3player.retromusic.R.string.the_audio_file),
                        "\u201C" + currentlyListening + "\u201D",

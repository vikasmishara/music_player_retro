...
import themusicplayer.audioplayer.mp3player.retromusic.activities.AboutActivity;
import themusicplayer.audioplayer.mp3player.retromusic.activities.AlbumDetailsActivity;
import themusicplayer.audioplayer.mp3player.retromusic.activities.ArtistDetailActivity;
import themusicplayer.audioplayer.mp3player.retromusic.activities.DriveModeActivity;
import themusicplayer.audioplayer.mp3player.retromusic.activities.GenreDetailsActivity;
import themusicplayer.audioplayer.mp3player.retromusic.activities.LicenseActivity;
import themusicplayer.audioplayer.mp3player.retromusic.activities.LyricsActivity;
import themusicplayer.audioplayer.mp3player.retromusic.activities.PlayingQueueActivity;
import themusicplayer.audioplayer.mp3player.retromusic.activities.PlaylistDetailActivity;
import themusicplayer.audioplayer.mp3player.retromusic.activities.PurchaseActivity;
import themusicplayer.audioplayer.mp3player.retromusic.activities.SearchActivity;
import themusicplayer.audioplayer.mp3player.retromusic.activities.SettingsActivity;
import themusicplayer.audioplayer.mp3player.retromusic.activities.SupportDevelopmentActivity;
import themusicplayer.audioplayer.mp3player.retromusic.activities.UserInfoActivity;
import themusicplayer.audioplayer.mp3player.retromusic.activities.WhatsNewActivity;
import themusicplayer.audioplayer.mp3player.retromusic.activities.bugreport.BugReportActivity;
...
import static themusicplayer.audioplayer.mp3player.retromusic.Constants.RATE_ON_GOOGLE_PLAY;
import static themusicplayer.audioplayer.mp3player.retromusic.util.RetroUtil.openUrl;

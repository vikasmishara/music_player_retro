...
package themusicplayer.audioplayer.mp3player.retromusic.appshortcuts

import android.app.Activity
import android.content.Intent
import android.os.Bundle
import themusicplayer.audioplayer.mp3player.retromusic.activities.SearchActivity
import themusicplayer.audioplayer.mp3player.retromusic.appshortcuts.shortcuttype.LastAddedShortcutType
import themusicplayer.audioplayer.mp3player.retromusic.appshortcuts.shortcuttype.SearchShortCutType
import themusicplayer.audioplayer.mp3player.retromusic.appshortcuts.shortcuttype.ShuffleAllShortcutType
import themusicplayer.audioplayer.mp3player.retromusic.appshortcuts.shortcuttype.TopTracksShortcutType
...
import themusicplayer.audioplayer.mp3player.retromusic.model.smartplaylist.ShuffleAllPlaylist
...
class AppShortcutLauncherActivity : Activity() {
    ...
    companion object {
        const val KEY_SHORTCUT_TYPE = "themusicplayer.audioplayer.mp3player.retromusic.appshortcuts.ShortcutType"

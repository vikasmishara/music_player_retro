                ...
                if (grantResult != PackageManager.PERMISSION_GRANTED) {
                    if (ActivityCompat.shouldShowRequestPermissionRationale(
                        ...
                        Snackbar.make(
                            ...
                            .setAction(themusicplayer.audioplayer.mp3player.retromusic.R.string.action_grant) { requestPermissions() }
                        ...
                        Snackbar.make(
                            ...
                            permissionDeniedMessage!!,
                            Snackbar.LENGTH_INDEFINITE
                        ).setAction(themusicplayer.audioplayer.mp3player.retromusic.R.string.action_settings) {
                            val intent = Intent()

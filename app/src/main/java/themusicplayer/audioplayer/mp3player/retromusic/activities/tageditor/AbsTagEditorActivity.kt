...
import themusicplayer.audioplayer.mp3player.retromusic.R.drawable
...
abstract class AbsTagEditorActivity : AbsBaseActivity() {
    ...
    private fun setUpImageView() {
        loadCurrentImage()
        items = listOf(
            getString(themusicplayer.audioplayer.mp3player.retromusic.R.string.pick_from_local_storage),
            getString(themusicplayer.audioplayer.mp3player.retromusic.R.string.web_search),
            getString(themusicplayer.audioplayer.mp3player.retromusic.R.string.remove_cover)
        )
